  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <form id="watcherForm" name="watcher-form" method="post" action="../../data.php" novalidate="novalidate">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="residence" id="Residence" placeholder="City / Country">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="countryOfBank">Country of Bank</label>
              <input type="text" class="form-control" name="countryOfBank" id="countryOfBank" placeholder="Country of Bank">
            </div>
            <label for="countryOfBank">Please read the following Terms and Conditions carefully.</label>
            ...
            <div class="form-group">
              ...
              <label class="form-label" for="termsCondition">I Agree to the Terms and Conditions and the Privacy Policy</label>
            </div>
